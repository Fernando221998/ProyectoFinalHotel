                ...
                <div class="modal-body">
                    ...
                    <?php                    
                        if(isset($_SESSION["datosCliente"])){
                            $datoNombreUsuario = $_SESSION["datosCliente"]->getNomUsuario();
                            $datoContrasena = $_SESSION["datosCliente"]->getContrasena();
                            $datoNombre = $_SESSION["datosCliente"]->getNombre();                         
                            $datoemail = $_SESSION["datosCliente"]->getEmail();
                    ?>
                        <div class="form-group pb-3">
                            <label for="nomUsuClienteRe">Nombre de usuario</label>
                            <input type="text" class="form-control mt-2" name="nomUsuClienteRe" id="nomUsuClienteRe" placeholder="Escriba un nombre de usuario..." maxlength="25" pattern="[0-9a-zA-ZàáâäãåąčćęèéêëėįìíîïłńòóôöõøùúûüųūÿýżźñçčšžÀÁÂÄÃÅĄĆČĖĘÈÉÊËÌÍÎÏĮŁŃÒÓÔÖÕØÙÚÛÜŲŪŸÝŻŹÑßÇŒÆČŠŽ∂ð]{2,25}" required value="<?=$datoNombreUsuario?>">
                        ...
                        <div class="form-group pb-3">
                            ...
                            <input type="email" class="form-control mt-2" name="emailClienteRe" id="emailClienteRe" placeholder="Escribe tu email, ejemplo:fernando@gmail.com" maxlength="100" pattern="[a-zA-Z0-9._]+@[a-z0-9.]+\.[a-z]{2,4}$" required value="<?=$datoemail?>">
                            <div class="invalid-feedback">
                        ...
                        <div class="form-group pb-3">
                            ...
                            <input type="password" class="form-control mt-2" name="contraClienteRe" pattern="[0-9a-zA-ZàáâäãåąčćęèéêëėįìíîïłńòóôöõøùúûüųūÿýżźñçčšžÀÁÂÄÃÅĄĆČĖĘÈÉÊËÌÍÎÏĮŁŃÒÓÔÖÕØÙÚÛÜŲŪŸÝŻŹÑßÇŒÆČŠŽ∂ð*+_.]{1,20}" id="contraClienteRe" placeholder="Elige una contraseña..."  maxlength="20" required value="<?=$datoContrasena?>"> 
                            <div class="invalid-feedback">
                        ...
                        <div class="form-group pb-3">
                            ...
                            <input type="password" class="form-control mt-2" name="ConfirmaContraClienteRe" id="ConfirmaContraClienteRe" placeholder="Escribe de nuevo tu contraseña..." maxlength="20" required value="<?=$datoContrasena?>"> 
                        </div> 
                    <?php
                    }else{
                    ?>
